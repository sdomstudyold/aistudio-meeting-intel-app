...
import { UploadCloud, FileText, Settings2, Info, Shield, Sparkles, Loader2 } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="bg-white border border-border-subtle p-8 flex flex-col space-y-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="font-h2-module text-sm">Planned Content</h3>
            ...
            <div className="bg-white border border-border-subtle p-8 flex flex-col space-y-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="font-h2-module text-sm">Actual Content</h3>
